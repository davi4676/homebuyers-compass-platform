...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#e8eef9] via-[#f2f6fc] to-[#f8fafc] text-[rgb(var(--text-dark))] font-sans antialiased">
      ...
      <section id="landing-hero" className="relative flex min-h-[420px] flex-col md:min-h-[520px]">
        <div
          className="absolute inset-0 z-0 bg-cover bg-center"
          style={{
            backgroundImage:
              'linear-gradient(to top, rgba(0,0,0,0.75) 0%, rgba(0,0,0,0.35) 50%, rgba(0,0,0,0.1) 100%), url(https://images.unsplash.com/photo-1570129477492-45c003edd2be?w=1600&q=80)',
            backgroundPosition: 'center',
            backgroundSize: 'cover',
          }}
        />
        {/* Hero title */}
        <div className="relative z-10 flex flex-1 flex-col items-center justify-center px-4 pb-6 pt-6 text-center sm:pt-10">
          <div className="max-w-3xl">
            <h1
              className="font-display text-[1.65rem] sm:text-[2.1rem] md:text-[2.65rem] lg:text-[3.1rem] font-bold text-white mb-3 tracking-tight leading-[1.15]"
        ...
        <div className="relative z-10 px-4 pb-4 md:pb-4">
          <div className="mx-auto max-w-5xl overflow-x-auto pb-1 scrollbar-hide md:overflow-visible md:pb-0">
            <div className="flex flex-nowrap items-center justify-start gap-2 whitespace-nowrap md:flex-wrap md:justify-center md:whitespace-normal">
              {[
                ...
                <span
                  key={label}
                  className="inline-flex shrink-0 items-center gap-1.5 rounded-full border border-gray-200 bg-white/90 px-3 py-1.5 text-sm font-medium text-brand-forest shadow-sm"
                >
        ...
        <div id="icp-selector" className="relative z-20 w-full max-w-5xl mx-auto px-4 -mb-14 scroll-mt-24">
            ...
            <div className="mt-6 grid grid-cols-1 gap-3 sm:grid-cols-2">
              {(
                ...
                return (
                  ...
                  >
                    <I className="h-8 w-8 shrink-0 text-brand-forest" aria-hidden />
                    ...
                    <Link
                      ...
                      className="mt-4 flex w-full items-center justify-center rounded-md bg-brand-forest py-3 text-center text-sm font-medium text-white transition hover:brightness-90"
                    >
          ...
          <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="mb-8">
              <CountUpNumber
                ...
                prefix="$"
                duration={2000}
                className="text-5xl font-bold text-brand-forest"
              />
              <p className="mt-2 text-base text-gray-600">average saved per buyer</p>
              <p className="mt-2 text-sm text-gray-500">
                Join 6,303 homebuyers who&apos;ve already used NestQuest
              </p>
            </div>
            <Link
              href={ctaHref('first-time')}

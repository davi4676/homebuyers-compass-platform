...
export const JOURNEY_LEARN_MONEY_ITEMS: LearnMoneyItem[] = [
  ...
  },
  {
    id: 'fha-101',
    title: 'FHA loans 101',
    sub: '3.5% down, MIP, and when FHA beats conventional.',
    tag: 'Program guide',
    href: '/resources#resource-fha-guide',
    moneyTags: ['finds_funds', 'saves_money'],
  },
  {
    id: 'va-101',
    title: 'VA loans 101',
    sub: 'Zero down and no monthly PMI for eligible veterans.',
    tag: 'Program guide',
  ...
  },
  {
    ...
    sub: 'FHA vs conventional vs VA vs USDA side-by-side.',
    tag: 'Program guide',
    href: '/resources#resource-loan-program-comparison',
    moneyTags: ['finds_funds', 'alternative_solution'],
  },
  {
    id: 'house-hack',
